...
export default function Navbar() {
  ...
  return (
    <nav
      className="sticky top-5 z-50 bg-[#00AFC7] p-4 rounded-b-3xl border-4 border-black dark:border-[#00AFC7] sm:w-2/4 max-w-6xl sm:mx-auto mx-4 shadow-[6px_6px_0_0_#000] dark:shadow-[0px_0px_0_0_transparent]"
    >
